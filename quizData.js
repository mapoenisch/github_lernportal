...
window.QUIZ_DATA = {
  ...
  '2.4.6': {
    title: 'Wissenscheck',
    intro: 'Teste dein Wissen zu Lead Routing in HubSpot.',
    questions: [
      {
        question: 'Was beschreibt Lead Routing?',
        options: [
          { id: 'A', text: 'Die Bewertung von Leads mit Punkten nach Verhalten und Profil' },
          { id: 'B', text: 'Die automatische Verteilung eingehender Leads nach festen Regeln an zuständige Personen' },
          { id: 'C', text: 'Die Einteilung von Leads in Gruppen nach Branche und Firmengröße' },
          { id: 'D', text: 'Das Versenden automatisierter Nurturing-Mails an kalte Leads' },
        ],
        correctAnswer: 'B',
        hint: 'Scoring misst Qualität, Segmentierung gruppiert – Routing teilt zu.',
      },
      {
        question: 'Wie viele Käufer entscheiden sich laut der Lektion für den Anbieter, der zuerst reagiert?',
        options: [
          { id: 'A', text: '25 %' },
          { id: 'B', text: '48 %' },
          { id: 'C', text: '60 %' },
        ...
        correctAnswer: 'D',
        hint: 'Schnelligkeit schlägt in diesem Fall sogar den Preis.',
      },
      {
        question: 'Warum genügt die reine Zuweisung eines Leads nicht?',
        options: [
          { id: 'A', text: 'Weil HubSpot das Owner-Feld nicht automatisch setzen kann' },
          { id: 'B', text: 'Weil ohne Aufgabe mit Frist niemand merkt, dass ein Lead liegen geblieben ist' },
          { id: 'C', text: 'Weil Leads grundsätzlich doppelt zugewiesen werden müssen' },
          { id: 'D', text: 'Weil die Zuweisung nur bei Round Robin funktioniert' },
        ],
        correctAnswer: 'B',
        hint: 'Erst eine Eskalationsregel macht einen verstaubenden Lead sichtbar.',
      },
      {
        question: 'Welche Kennzahl ist im Lead Routing die wichtigste?',
        options: [
          { id: 'A', text: 'Die Zeit bis zum Erstkontakt' },
          { id: 'B', text: 'Die Anzahl der angelegten Workflows' },
          { id: 'C', text: 'Die Gesamtzahl der Leads im CRM' },
          { id: 'D', text: 'Die Anzahl der Teams in HubSpot' },
        ],
        correctAnswer: 'A',
        hint: 'Alles andere im Routing dient nur dazu, genau diese Zeit kurz zu halten.',
      },
    ],
  },
  '2.4.7': {
    title: 'Wissenscheck',
    intro: 'Teste dein Wissen zu Datenqualität und Datenpflege im CRM.',
    questions: [
      {
        question: 'Welche Felder solltest du laut der Lektion vorrangig sauber halten?',
        options: [
          { id: 'A', text: 'Alle Felder gleichermaßen, Lücken sind immer kritisch' },
          { id: 'B', text: 'Nur Freitextfelder, weil dort am meisten Kontext steht' },
          { id: 'C', text: 'Die Felder, auf denen Scoring, Routing oder Reporting aufbauen' },
          { id: 'D', text: 'Ausschließlich Kontaktdaten wie Name und Telefonnummer' },
        ],
        correctAnswer: 'C',
        hint: 'Perfekte Daten gibt es nicht – entscheidend ist, ob eine Automatik auf dem Feld aufbaut.',
      },
      {
        question: 'Fünf Kontakte tragen „Gastronomie", „gastro", „Systemgastro GmbH", „Gastro/Catering" und „gastronomie ". Was ist die richtige Lösung?',
        options: [
          { id: 'A', text: 'Das Feld regelmäßig manuell nachbereinigen' },
          { id: 'B', text: 'Den Feldtyp ändern: ein Dropdown lässt die Varianten gar nicht erst zu' },
          { id: 'C', text: 'Den Filter so lange erweitern, bis alle Varianten erfasst sind' },
          { id: 'D', text: 'Die betroffenen Kontakte löschen und neu anlegen' },
        ],
        correctAnswer: 'B',
        hint: 'Freitext gehört in Notizen, nicht in Felder, mit denen du arbeiten willst.',
      },
      {
        question: 'Wohin gehört die Angabe „Branche" im HubSpot-Datenmodell?',
        options: [
          { id: 'A', text: 'An den Kontakt, damit jede Person individuell gepflegt wird' },
          { id: 'B', text: 'An den Deal, weil sie die Verkaufschance beschreibt' },
          { id: 'C', text: 'An das Unternehmen, weil sie für die ganze Firma gilt' },
          { id: 'D', text: 'An das Ticket, weil sie erst im Service relevant wird' },
        ],
        correctAnswer: 'C',
        hint: 'Bei fünf Ansprechpartnern derselben Firma stünde sie am Kontakt fünfmal da.',
      },
      {
        question: 'Im Fallbeispiel erreichen nur 12 von 800 Kontakten den Schwellenwert von 60 Punkten. Woran liegt das?',
        options: [
          { id: 'A', text: 'Das Scoring-Modell war falsch aufgebaut' },
          { id: 'B', text: 'Die Leads waren tatsächlich zu schlecht' },
          { id: 'C', text: 'Die Felder, auf denen das Modell aufbaut, waren größtenteils leer' },
          { id: 'D', text: 'Der Schwellenwert war zu niedrig angesetzt' },
        ],
        correctAnswer: 'C',
        hint: 'Für die meisten Kontakte waren maximal 20 statt 60 Punkte erreichbar.',
      },
    ],
  },
  '2.4.8': {
    title: 'Wissenscheck',
    intro: 'Teste dein Wissen zur Reaktivierung von Leads.',
    questions: [
      {
        question: 'Was unterscheidet Reaktivierung von Lead Nurturing?',
        options: [
          { id: 'A', text: 'Nurturing begleitet neue, warme Interessenten – Reaktivierung holt abgekühlte oder abgesprungene Kontakte zurück' },
          { id: 'B', text: 'Reaktivierung richtet sich nur an Bestandskunden, Nurturing nur an Neukunden' },
          { id: 'C', text: 'Nurturing läuft manuell, Reaktivierung immer automatisiert' },
          { id: 'D', text: 'Es gibt keinen Unterschied, beide Begriffe meinen dasselbe' },
        ],
        correctAnswer: 'A',
        hint: 'Der Auslöser ist verschieden: frischer Lead versus neuer Anlass.',
      },
      {
        question: 'Welcher Verlustgrund eignet sich am besten für eine Reaktivierung?',
        options: [
          { id: 'A', text: 'Kein Bedarf oder kein Fit' },
          { id: 'B', text: 'Zu teuer oder Budget' },
          { id: 'C', text: 'Falsche Branche' },
          { id: 'D', text: 'Kein Interesse am Produktbereich' },
        ],
        correctAnswer: 'B',
        hint: 'Dieser Blocker ist oft nur zeitlich oder über ein neues Angebot lösbar.',
      },
      {
        question: 'Welche zwei CRM-Felder sind laut der Lektion die wichtigsten Reaktivierungs-Auslöser?',
        options: [
          { id: 'A', text: 'Lead-Quelle und Kampagnenname' },
          { id: 'B', text: 'Verlustgrund und aktuell genutztes Wettbewerber-System' },
          { id: 'C', text: 'Telefonnummer und E-Mail-Adresse' },
          { id: 'D', text: 'Lifecycle-Phase und Newsletter-Status' },
        ],
        correctAnswer: 'B',
        hint: 'Diese zwei Felder verwandeln einen verlorenen Deal in eine gezielte Chance.',
      },
      {
        question: 'Woran erkennst du, dass eine Reaktivierungs-Ansprache zu breit oder zu aufdringlich war?',
        options: [
          { id: 'A', text: 'Die Reaktivierungsquote steigt' },
          { id: 'B', text: 'Die Zahl der Abmeldungen steigt' },
          { id: 'C', text: 'Mehr verlorene Deals kommen in die Pipeline zurück' },
          { id: 'D', text: 'Der reaktivierte Umsatz sinkt leicht' },
        ],
        correctAnswer: 'B',
        hint: 'Wer wahllos alte Kontakte anschreibt, wirkt verzweifelt und landet schneller im Spam.',
      },
    ],
  },
  '2.4.9': {
    title: 'Wissenscheck',
    intro: 'Teste dein Wissen zur Steuerung des Lead Managements.',
    questions: [
      {
        question: 'Im Beispiel-Funnel werden aus 1.000 Besuchern 100 Leads, 40 MQL, 12 SQL und 1 Kunde. Welcher Übergang ist der Engpass?',
        options: [
          { id: 'A', text: 'Besucher → Lead' },
          { id: 'B', text: 'Lead → MQL' },
          { id: 'C', text: 'MQL → SQL' },
          { id: 'D', text: 'SQL → Kunde' },
        ],
        correctAnswer: 'D',
        hint: 'Bei 8 % gegenüber typischen 20 bis 30 % bricht die Kette ein.',
      },
      {
        question: 'Was bringt laut der Lektion mehr: 10 % mehr Besucher oder die Abschlussquote von 8 auf 20 % heben?',
        options: [
          { id: 'A', text: 'Mehr Besucher, weil oben im Funnel der größte Hebel liegt' },
          { id: 'B', text: 'Beides wirkt etwa gleich stark' },
          { id: 'C', text: 'Den Engpass zu reparieren – es schlägt mehr Traffic um das Vierzehnfache' },
          { id: 'D', text: 'Keine der beiden Maßnahmen verändert das Ergebnis messbar' },
        ],
        correctAnswer: 'C',
        hint: 'Aus 12 SQL werden dann 2,4 statt 1 Kunde.',
      },
      {
        question: 'Wozu dient das Rückwärtsrechnen vom Umsatzziel?',
        options: [
          { id: 'A', text: 'Um aus dem Ziel über Dealwert und eigene Quoten die nötige Leadzahl pro Monat abzuleiten' },
          { id: 'B', text: 'Um Branchen-Benchmarks für die Quoten zu ermitteln' },
          { id: 'C', text: 'Um den Customer Lifetime Value zu berechnen' },
          { id: 'D', text: 'Um die Kosten pro Lead zu senken' },
        ],
        correctAnswer: 'A',
        hint: 'Die Rechnung funktioniert nur mit deinen eigenen Quoten – erst messen, dann planen.',
      },
      {
        question: 'Bei Startup Beta liegt die MQL-zu-SQL-Conversion unter 5 %. Welche Ursache nennt die Lektion?',
        options: [
          { id: 'A', text: 'Das Marketing generiert zu wenige Leads' },
          { id: 'B', text: 'Zu lasche MQL-Kriterien und ein schwacher Nachfass-Prozess' },
          { id: 'C', text: 'Die Preise sind zu hoch' },
          { id: 'D', text: 'Das CRM ist technisch überlastet' },
        ],
        correctAnswer: 'B',
        hint: 'Wenn jeder Download als MQL zählt, bekommt Sales unqualifizierte Leads – und 70 % werden nie kontaktiert.',
      },
    ],
  },
  '2.4.11': {
    title: 'Wissenscheck',
    intro: 'Teste dein Wissen zur Nutzung von Vertriebsdaten.',
    questions: [
      {
        question: 'Was unterscheidet Rohdaten von einer KPI?',
        options: [
          { id: 'A', text: 'Rohdaten sind immer falsch, KPIs immer korrekt' },
          { id: 'B', text: 'Rohdaten sind unverarbeitete Zahlen, KPIs setzen sie ins Verhältnis und geben Kontext' },
          { id: 'C', text: 'KPIs stammen aus dem CRM, Rohdaten aus dem Web-Tracking' },
          { id: 'D', text: 'Rohdaten sind Prozentwerte, KPIs absolute Zahlen' },
        ],
        correctAnswer: 'B',
        hint: '150 Leads ist eine Zahl, eine Conversion-Rate von 10 % zeigt Erfolg.',
      },
      {
        question: 'Wie unterscheidest du Saisonalität von einer echten Veränderung?',
        options: [
          { id: 'A', text: 'Mit dem Vormonat vergleichen' },
          { id: 'B', text: 'Mit dem Vorjahreszeitraum vergleichen (like-for-like)' },
          { id: 'C', text: 'Den höchsten Monat als Referenz nehmen' },
          { id: 'D', text: 'Ausschließlich absolute Zahlen betrachten' },
        ],
        correctAnswer: 'B',
        hint: 'Sonst wirkt Saison wie ein Trend.',
      },
      {
        question: 'Mitarbeiter A schließt 9 von 10 Deals ab, Mitarbeiter B 20 von 100. Welcher Denkfehler droht?',
        options: [
          { id: 'A', text: 'Die Prozentzahl von A überzeugt, obwohl die Stichprobe sehr klein ist und B absolut mehr Abschlüsse hat' },
          { id: 'B', text: 'B ist objektiv der schwächere Verkäufer' },
          { id: 'C', text: 'Beide Quoten sind nicht vergleichbar, weil sie aus verschiedenen Systemen kommen' },
          { id: 'D', text: 'Prozentwerte sind grundsätzlich aussagekräftiger als absolute Zahlen' },
        ],
        correctAnswer: 'A',
        hint: 'Immer Kontext prüfen: Stichprobe, Zeitraum und Ursache.',
      },
      {
        question: 'Was unterscheidet Früh- von Spätindikatoren?',
        options: [
          { id: 'A', text: 'Frühindikatoren wie Pipeline-Zugänge und Termine erlauben rechtzeitiges Gegensteuern, Spätindikatoren wie Umsatz bestätigen nur' },
          { id: 'B', text: 'Frühindikatoren sind ungenau, Spätindikatoren präzise' },
          { id: 'C', text: 'Frühindikatoren gelten nur im Marketing, Spätindikatoren nur im Vertrieb' },
          { id: 'D', text: 'Spätindikatoren lassen sich leichter beeinflussen' },
        ],
        correctAnswer: 'A',
        hint: 'Wer nur auf Spätindikatoren schaut, steuert rückwärts.',
      },
    ],
  },
  '2.4.12': {
    title: 'Wissenscheck',
    intro: 'Teste dein Wissen zum Reporting im Vertrieb.',
    questions: [
      {
        question: 'Was unterscheidet Reporting von einer Analyse?',
        options: [
          { id: 'A', text: 'Reporting ist die einmalige Auswertung, Analyse der wiederkehrende Blick' },
          { id: 'B', text: 'Analyse ist die Stichprobe, Reporting der Dauerlauf mit denselben Kennzahlen' },
          { id: 'C', text: 'Reporting nutzt nur Rohdaten, Analyse nur KPIs' },
          { id: 'D', text: 'Analyse erfolgt im CRM, Reporting nur in Tabellen' },
        ],
        correctAnswer: 'B',
        hint: 'Aus einmaligen Erkenntnissen werden mit Reporting laufende Entscheidungen.',
      },
      {
        question: 'Warum reicht eine einzelne KPI nicht aus?',
        options: [
          { id: 'A', text: 'Weil KPIs im CRM nicht automatisch aktualisiert werden' },
          { id: 'B', text: 'Weil ein Report Kontext liefert, Kennzahlen verbindet und die Verteilung statt nur den Mittelwert zeigt' },
          { id: 'C', text: 'Weil eine KPI immer falsch berechnet ist' },
          { id: 'D', text: 'Weil KPIs nur für das Management relevant sind' },
        ],
        correctAnswer: 'B',
        hint: 'Eine KPI ist ein Datenpunkt, ein Report die Geschichte dahinter.',
      },
      {
        question: 'Welcher Report-Typ beantwortet die Frage „Wie viel Umsatz ist im Quartal zu erwarten?"',
        options: [
          { id: 'A', text: 'Funnel- und Conversion-Report' },
          { id: 'B', text: 'Aktivitäts-Report' },
          { id: 'C', text: 'Pipeline- und Forecast-Report' },
          { id: 'D', text: 'Zufriedenheits-Report' },
        ],
        correctAnswer: 'C',
        hint: 'Er bewertet offene Deals nach Wahrscheinlichkeit und Wert.',
      },
      {
        question: 'Was ist ein Vanity-Report?',
        options: [
          { id: 'A', text: 'Ein Report, der nur dem Management vorgelegt wird' },
          { id: 'B', text: 'Ein Report mit schönen Zahlen, aber ohne Konsequenz und Maßnahme' },
          { id: 'C', text: 'Ein Report, der mehr als zehn Kennzahlen enthält' },
          { id: 'D', text: 'Ein Report ohne Diagramme' },
        ],
        correctAnswer: 'B',
        hint: 'Ein Report ohne Maßnahme ist verschwendete Zeit.',
      },
    ],
  },
  '2.4.13': {
    title: 'Wissenscheck',
    intro: 'Teste dein Wissen zu Sales Dashboards.',
    questions: [
      {
        question: 'Wie viele KPIs sollte ein gutes Sales Dashboard laut der Lektion zeigen?',
        options: [
          { id: 'A', text: 'Genau 3' },
          { id: 'B', text: 'Die 5 bis 10 wichtigsten' },
          { id: 'C', text: 'Mindestens 20, um vollständig zu sein' },
          { id: 'D', text: 'So viele wie technisch möglich' },
        ],
        correctAnswer: 'B',
        hint: 'Fokussiert, übersichtlich, handlungsorientiert – statt in Zahlen zu ertrinken.',
      },
      {
        question: 'Welcher Diagrammtyp passt zu Trends über die Zeit?',
        options: [
          { id: 'A', text: 'Balken' },
          { id: 'B', text: 'Linien' },
          { id: 'C', text: 'Torten' },
        ...
        correctAnswer: 'B',
        hint: 'Balken für Vergleiche, Torten für Anteile.',
      },
      {
        question: 'Warum sind Ziele im Dashboard wichtig?',
        options: [
          { id: 'A', text: 'Ohne Ziel fehlt der Maßstab – erst Soll gegen Ist macht Zahlen aussagekräftig' },
          { id: 'B', text: 'Weil HubSpot ohne Ziele keine Reports erstellen kann' },
          { id: 'C', text: 'Weil Ziele die Anzahl der nötigen KPIs reduzieren' },
          { id: 'D', text: 'Weil Ziele die Datenqualität verbessern' },
        ],
        correctAnswer: 'A',
        hint: 'Abweichungen sind das Handlungssignal.',
      },
      {
        question: 'Welche KPI ist für SaaSCo als SaaS-Anbieter besonders entscheidend?',
        options: [
          { id: 'A', text: 'Website-Views' },
          { id: 'B', text: 'Anzahl der versendeten E-Mails' },
          { id: 'C', text: 'MRR, der monatlich wiederkehrende Umsatz' },
          { id: 'D', text: 'Anzahl der angelegten Kontakte' },
        ],
        correctAnswer: 'C',
        hint: 'Beispiel aus der Lektion: „10 Deals = 8.000 € MRR im April".',
      },
    ],
  },
  '2.4.14': {
    title: 'Wissenscheck',
    intro: 'Teste dein Wissen zu Pipeline Management und Umsatzprognose.',
    questions: [
      {
        question: 'Wie hoch muss die Pipeline-Coverage bei einer Win Rate von 25 % ungefähr sein?',
        options: [
          { id: 'A', text: 'Das Einfache des Ziels' },
          { id: 'B', text: 'Das Doppelte des Ziels' },
          { id: 'C', text: 'Das Vierfache des Ziels' },
          { id: 'D', text: 'Das Zehnfache des Ziels' },
        ],
        correctAnswer: 'C',
        hint: 'Die Faustregel lautet ungefähr eins geteilt durch die Win Rate.',
      },
      {
        question: 'Ein Deal über 10.000 € liegt in einer Phase mit 60 % Abschlusswahrscheinlichkeit. Mit welchem Wert geht er in den Forecast ein?',
        options: [
          { id: 'A', text: '10.000 €' },
          { id: 'B', text: '6.000 €' },
          { id: 'C', text: '4.000 €' },
        ...
        correctAnswer: 'B',
        hint: 'Wert mal Wahrscheinlichkeit ergibt den gewichteten Beitrag.',
      },
      {
        question: 'Was passiert mit einem Deal ohne Abschlussdatum?',
        options: [
          { id: 'A', text: 'Er wird automatisch als gewonnen gezählt' },
          { id: 'B', text: 'Er fällt aus der Prognose heraus' },
          { id: 'C', text: 'Er erhält automatisch 50 % Wahrscheinlichkeit' },
          { id: 'D', text: 'Er wird aus der Pipeline gelöscht' },
        ],
        correctAnswer: 'B',
        hint: 'Deshalb gehören Betrag und Abschlussdatum zur Pipeline-Hygiene.',
      },
      {
        question: 'Woran scheitern die meisten Prognosen?',
        options: [
          { id: 'A', text: 'An der gewählten Forecasting-Methode' },
          { id: 'B', text: 'An unsauberen Daten' },
          { id: 'C', text: 'An fehlender Software' },
          { id: 'D', text: 'An zu großen Deals' },
        ],
        correctAnswer: 'B',
        hint: 'Genauigkeit entsteht durch Disziplin: gepflegte Daten, ehrliche Einschätzungen, regelmäßiger Abgleich.',
      },
    ],
  },
  '2.6.1': {
    title: 'Wissenscheck',
    intro: 'Teste dein Wissen zum Recap Reibungsloser Vertrieb und Sales Enablement.',
    questions: [
      {
        question: 'Was bedeutet Inbound Sales?',
        options: [
          { id: 'A', text: 'Das Unternehmen geht aktiv per Anruf und E-Mail auf potenzielle Kunden zu' },
          { id: 'B', text: 'Kunden kommen von selbst auf das Unternehmen zu, angezogen durch Content und Marketing' },
          { id: 'C', text: 'Leads werden von externen Dienstleistern eingekauft' },
          { id: 'D', text: 'Vertrieb findet ausschließlich auf Messen statt' },
        ],
        correctAnswer: 'B',
        hint: 'Outbound ist der aktive Weg nach außen, Inbound der Weg zu dir.',
      },
      {
        question: 'Aus welchen drei Bestandteilen besteht Sales Enablement?',
        options: [
          { id: 'A', text: 'Prozesse, Inhalte und Technologien' },
          { id: 'B', text: 'Preis, Produkt und Platzierung' },
          { id: 'C', text: 'Leads, Deals und Tickets' },
          { id: 'D', text: 'Marketing, Vertrieb und Service' },
        ],
        correctAnswer: 'A',
        hint: 'Sie ermöglichen es Vertriebsteams, effizienter und schneller zu verkaufen.',
      },
      {
        question: 'Wer ist für die Qualifizierung eines SQL zuständig, und nach welchen Kriterien?',
        options: [
          { id: 'A', text: 'Marketing, anhand von Downloads und Webinar-Teilnahmen' },
          { id: 'B', text: 'Sales, anhand von Budget, Entscheidungsbefugnis, Bedarf und Zeitrahmen (BANT)' },
          { id: 'C', text: 'Der Service, anhand offener Tickets' },
          { id: 'D', text: 'Die Geschäftsführung, anhand des Umsatzpotenzials' },
        ],
        correctAnswer: 'B',
        hint: 'Der MQL liegt beim Marketing, der SQL beim Vertrieb.',
      },
      {
        question: 'Was ist ein Hero Statement?',
        options: [
          { id: 'A', text: 'Ein Slogan für die Startseite der Website' },
          { id: 'B', text: 'Ein kurzer Satz, der Persona und Job to be Done zu einer Kernbotschaft verbindet' },
          { id: 'C', text: 'Die Zusammenfassung eines Verkaufsgesprächs im CRM' },
          { id: 'D', text: 'Das Umsatzziel eines Key Accounts' },
        ],
        correctAnswer: 'B',
        hint: 'Für (Persona), die (Job to be Done), bieten wir (Produkt), damit (Nutzen).',
      },
    ],
  },
  '2.6.2': {
    title: 'Wissenscheck',
    intro: 'Teste dein Wissen zum Recap Inbound Sales.',
    questions: [
      {
        question: 'Wie lauten die vier Phasen des Inbound Sales in der richtigen Reihenfolge?',
        options: [
          { id: 'A', text: 'Kontakt, Identifizieren, Beraten, Erkunden' },
          { id: 'B', text: 'Identifizieren, Kontakt, Erkunden, Beraten' },
          { id: 'C', text: 'Erkunden, Identifizieren, Kontakt, Beraten' },
          { id: 'D', text: 'Identifizieren, Erkunden, Beraten, Kontakt' },
        ],
        correctAnswer: 'B',
        hint: 'Erst finden, dann verbinden, dann verstehen, dann beraten.',
      },
      {
        question: 'Was ist ein Trigger Event?',
        options: [
          { id: 'A', text: 'Ein automatisierter Workflow-Schritt in HubSpot' },
          { id: 'B', text: 'Ein Ereignis beim Lead – etwa eine Stellenanzeige oder Pressemitteilung –, das einen guten Anlass zur Ansprache liefert' },
          { id: 'C', text: 'Der Moment, in dem ein Lead ein Formular ausfüllt' },
          { id: 'D', text: 'Ein Termin, den der Lead selbst gebucht hat' },
        ],
        correctAnswer: 'B',
        hint: 'Es zeigt an, dass du sofortigen Mehrwert bieten kannst.',
      },
      {
        question: 'Wie viele Kontaktversuche steigern laut der Lektion die Erfolgschancen, bevor die Effektivität sinkt?',
        options: [
          { id: 'A', text: 'Zwei' },
          { id: 'B', text: 'Fünf' },
          { id: 'C', text: 'Zehn' },
        ...
        correctAnswer: 'B',
        hint: 'Der siebte Kontakt bringt oft nicht mehr als der sechste.',
      },
      {
        question: 'Wofür steht das „P" in GPCTBA/C&I?',
        options: [
          { id: 'A', text: 'Price – der Preis, den der Kunde zahlen will' },
          { id: 'B', text: 'Plan – der Plan des Kunden, seine Herausforderung zu überwinden' },
          { id: 'C', text: 'Position – die Rolle des Ansprechpartners' },
          { id: 'D', text: 'Product – das gewünschte Produkt' },
        ],
        correctAnswer: 'B',
        hint: 'Die Frage dazu lautet: „Wie planst du, deine Herausforderung zu überwinden?"',
      },
    ],
  },
  '2.6.4': {
    title: 'Wissenscheck',
    intro: 'Teste dein Wissen zum Recap HubSpot Sales-Tools und Reporting.',
    questions: [
      {
        question: 'Was unterscheidet eine aktive von einer statischen Liste in HubSpot?',
        options: [
          { id: 'A', text: 'Die aktive Liste aktualisiert sich automatisch, die statische bleibt ein fester Schnappschuss' },
          { id: 'B', text: 'Die statische Liste aktualisiert sich automatisch, die aktive nicht' },
          { id: 'C', text: 'Aktive Listen lassen sich nicht für Workflows nutzen' },
          { id: 'D', text: 'Statische Listen sind auf 100 Kontakte begrenzt' },
        ],
        correctAnswer: 'A',
        hint: 'Die aktive Liste ist ein fortlaufender Filter, die statische ein Stand vom Erstellungszeitpunkt.',
      },
      {
        question: 'Welche HubSpot-Version bietet prädiktives, KI-basiertes Lead Scoring?',
        options: [
          { id: 'A', text: 'Free' },
          { id: 'B', text: 'Starter' },
        ...
        correctAnswer: 'D',
        hint: 'Manuelles Scoring über die Eigenschaft „HubSpot Score" gibt es bereits ab Professional.',
      },
      {
        question: 'Welches Bild beschreibt automatisiertes Lead Nurturing in der Lektion?',
        options: [
          { id: 'A', text: 'Eine Gießkanne, mit der jede Pflanze einzeln versorgt wird' },
          { id: 'B', text: 'Eine Sprinkleranlage, die alle Pflanzen regelmäßig versorgt' },
          { id: 'C', text: 'Ein Gewächshaus mit gleichbleibendem Klima' },
          { id: 'D', text: 'Ein Gärtner, der täglich neue Samen setzt' },
        ],
        correctAnswer: 'B',
        hint: 'Einmal einstellen, dauerhaft wirksam – die Gießkanne steht für die manuelle Variante.',
      },
      {
        question: 'Wie viele Reports lassen sich maximal auf einem HubSpot-Dashboard bündeln?',
        options: [
          { id: 'A', text: '5' },
          { id: 'B', text: '10' },
          { id: 'C', text: '25' },
          { id: 'D', text: 'Unbegrenzt' },
        ],
        correctAnswer: 'B',
        hint: 'Wichtiges nach oben: oben KPIs als Zahl, unten Diagramme für den Verlauf.',
      },
    ],
  },
  '2.7.1': {
    title: 'Wissenscheck',
    intro: 'Teste dein Wissen zu den Grundlagen des Key Account Managements.',
    questions: [
      {
        question: 'Was besagt das Pareto-Prinzip im Kontext von Key Accounts?',
        options: [
          { id: 'A', text: 'Etwa 20 % der Kunden generieren 80 % des Umsatzes' },
          { id: 'B', text: 'Etwa 80 % der Kunden generieren 20 % des Umsatzes' },
          { id: 'C', text: 'Jeder Kunde trägt gleich viel zum Umsatz bei' },
          { id: 'D', text: '20 % der Kunden verursachen 80 % der Kosten' },
        ],
        correctAnswer: 'A',
        hint: 'Wenige Kunden sind geschäftskritisch – genau sie nennen wir Key Accounts.',
      },
      {
        question: 'Woran erkennt man einen Key Account außer am Umsatz?',
        options: [
          { id: 'A', text: 'An der Zahl der offenen Tickets' },
          { id: 'B', text: 'Am Multiplikator-Effekt durch Referenzen und am strategischen Potenzial' },
          { id: 'C', text: 'An der Dauer der Vertragslaufzeit allein' },
          { id: 'D', text: 'An der Anzahl der Ansprechpartner im CRM' },
        ],
        correctAnswer: 'B',
        hint: 'Key Accounts sind geschäftskritische Partner mit Strahlkraft.',
      },
      {
        question: 'Wie unterscheidet sich KAM vom klassischen Vertrieb?',
        options: [
          { id: 'A', text: 'KAM fokussiert auf schnelle Abschlüsse, klassischer Vertrieb auf Beziehungen' },
          { id: 'B', text: 'KAM setzt auf langfristigen Beziehungsaufbau und eine Beraterrolle, klassischer Vertrieb auf Neukunden und schnelle Abschlüsse' },
          { id: 'C', text: 'KAM betreut nur Neukunden, klassischer Vertrieb nur Bestandskunden' },
          { id: 'D', text: 'Es gibt keinen relevanten Unterschied' },
        ],
        correctAnswer: 'B',
        hint: 'KAM ist kein schneller Verkauf, sondern strategische Beziehungspflege.',
      },
      {
        question: 'Welche vier Bausteine umfasst die KAM-Strategie aus der Lektion?',
        options: [
          { id: 'A', text: 'Ziele setzen, Premium-Service, Erfolge messen, Bedürfnisse antizipieren' },
          { id: 'B', text: 'Analysieren, Segmentieren, Scoren, Routen' },
          { id: 'C', text: 'Anziehen, Interagieren, Begeistern, Binden' },
          { id: 'D', text: 'Planen, Umsetzen, Prüfen, Abschließen' },
        ],
        correctAnswer: 'A',
        hint: 'Dazu kommen zwei Querschnittsthemen: Team-Effort koordinieren und Kontinuität sichern.',
      },
    ],
  },
  '2.7.2': {
    title: 'Wissenscheck',
    intro: 'Teste dein Wissen zur KAM-Strategie und Auswahl der Schlüsselkunden.',
    questions: [
      {
        question: 'Wie funktioniert eine Scorecard zur Key-Account-Auswahl?',
        options: [
          { id: 'A', text: 'Alle Kunden werden nach Umsatz sortiert, die Top 10 werden Key Accounts' },
          { id: 'B', text: 'Kriterien werden festgelegt und gewichtet, Kunden pro Kriterium bepunktet, Punkte mit Gewichtung multipliziert' },
          { id: 'C', text: 'Jeder Kunde bekommt eine Note von 1 bis 6 durch den zuständigen Vertriebler' },
          { id: 'D', text: 'HubSpot berechnet die Scorecard automatisch aus dem Lead Score' },
        ],
        correctAnswer: 'B',
        hint: 'Die Scorecard bringt Struktur, Vergleichbarkeit und fundierte Entscheidungen.',
      },
      {
        question: 'Welcher Fehler gehört zu den Don’ts bei der Key-Account-Auswahl?',
        options: [
          { id: 'A', text: 'Zu viele Key Accounts festlegen' },
          { id: 'B', text: 'Kriterien gewichten' },
          { id: 'C', text: 'Das Potenzial mitbewerten' },
          { id: 'D', text: 'Die Liste regelmäßig überprüfen' },
        ],
        correctAnswer: 'A',
        hint: 'Weniger ist mehr – sonst fehlt der Fokus für echte Betreuung.',
      },
      {
        question: 'Kunde A macht 500.000 € Umsatz bei geringem Wachstum und komplexen Prozessen, Kunde B 100.000 € mit starkem Wachstumspotenzial. Wen priorisieren die meisten – und warum?',
        options: [
          { id: 'A', text: 'Kunde A, weil der aktuelle Umsatz zählt' },
          { id: 'B', text: 'Kunde B, wegen des hohen Zukunftspotenzials – der ROI zusätzlicher Betreuung ist bei A geringer' },
          { id: 'C', text: 'Beide gleichermaßen, weil die Summe entscheidet' },
          { id: 'D', text: 'Keinen von beiden, weil keiner die Kriterien erfüllt' },
        ],
        correctAnswer: 'B',
        hint: 'Wachstum und Innovationsfreude schlagen hier den höheren Ist-Umsatz.',
      },
      {
        question: 'Wie wird die Rolle des Key Account Managers in der Lektion beschrieben?',
        options: [
          { id: 'A', text: 'Als „CEO seines Kunden", der Kundeninteressen vertritt und die Beziehung wie ein eigenes Projekt steuert' },
          { id: 'B', text: 'Als Innendienstmitarbeiter mit Fokus auf Angebotserstellung' },
          { id: 'C', text: 'Als Controller, der vor allem Umsatzzahlen prüft' },
          { id: 'D', text: 'Als Vertriebsleiter mit Weisungsbefugnis über alle Abteilungen' },
        ],
        correctAnswer: 'A',
        hint: 'Beziehungsmanager, Kundenversteher, Koordinator und Problemlöser in einem.',
      },
    ],
  },
  '2.7.3': {
    title: 'Wissenscheck',
    intro: 'Teste dein Wissen zur Key-Account-Planung und zu den Prozessen.',
    questions: [
      {
        question: 'Welcher Baustein steht am Anfang eines Account Plans?',
        options: [
          { id: 'A', text: 'Der Maßnahmenplan' },
          { id: 'B', text: 'Klar formulierte, gemeinsame Ziele – idealerweise SMART' },
          { id: 'C', text: 'Die Kommunikation und Steuerung' },
          { id: 'D', text: 'Das Review' },
        ],
        correctAnswer: 'B',
        hint: 'Ein klar formuliertes Ziel ist die Basis für alle weiteren Schritte.',
      },
      {
        question: 'Was gehört zur Kundenanalyse im Account Plan?',
        options: [
          { id: 'A', text: 'Nur der bisherige Umsatz des Kunden' },
          { id: 'B', text: 'Kundenprofil, Pain Points, abgeleitete Bedarfe und eine Stakeholder-Map' },
          { id: 'C', text: 'Ausschließlich die Wettbewerbspreise' },
          { id: 'D', text: 'Die interne Ressourcenplanung' },
        ],
        correctAnswer: 'B',
        hint: 'Je gründlicher die Analyse, desto passgenauer die Strategie.',
      },
      {
        question: 'Welcher Regelkreis liegt dem KAM-Zyklus zugrunde?',
        options: [
          { id: 'A', text: 'BANT' },
          { id: 'B', text: 'AIDA' },
          { id: 'C', text: 'PDCA – Plan, Do, Check, Act' },
          { id: 'D', text: 'SMART' },
        ],
        correctAnswer: 'C',
        hint: 'Nach dem Review beginnt der Zyklus mit neuen Zielen von vorn.',
      },
      {
        question: 'Was ist ein Executive Sponsor?',
        options: [
          { id: 'A', text: 'Ein externer Berater, der den Account Plan erstellt' },
          { id: 'B', text: 'Eine Führungskraft, die als strategischer Türöffner und Eskalationsinstanz dient' },
          { id: 'C', text: 'Der wichtigste Ansprechpartner auf Kundenseite' },
          { id: 'D', text: 'Ein Budgetposten für Kundenveranstaltungen' },
        ],
        correctAnswer: 'B',
        hint: 'Du führst als KAM, aber gewinnen kann nur das Team.',
      },
    ],
  },
  '2.7.4': {
    title: 'Wissenscheck',
    intro: 'Teste dein Wissen zu Herausforderungen und Best Practices im KAM.',
    questions: [
      {
        question: 'Warum ist die Abstimmung mit anderen Abteilungen für einen KAM schwierig?',
        options: [
          { id: 'A', text: 'Weil Abteilungen eigene Ziele haben und der KAM keine Weisungsbefugnis hat' },
          { id: 'B', text: 'Weil der KAM formal über allen Abteilungen steht' },
          { id: 'C', text: 'Weil Abteilungen keinen Zugriff auf das CRM haben' },
          { id: 'D', text: 'Weil Kundenkontakt grundsätzlich nur über den Vertrieb läuft' },
        ],
        correctAnswer: 'A',
        hint: 'Starke KAMs werden deshalb Brückenbauer: initiativ kommunizieren und Transparenz schaffen.',
      },
      {
        question: 'Wie gehst du mit einer Sonderforderung um, die nicht umsetzbar ist?',
        options: [
          { id: 'A', text: 'Zustimmen und später eine Verzögerung kommunizieren' },
          { id: 'B', text: 'Das „Warum" verstehen und höflich, aber klar ablehnen – mit Alternative und Begründung' },
          { id: 'C', text: 'Die Anfrage unbeantwortet lassen' },
          { id: 'D', text: 'Die Entscheidung komplett an die Geschäftsführung abgeben' },
        ],
        correctAnswer: 'B',
        hint: 'Kunden schätzen Ehrlichkeit mehr als leere Versprechen.',
      },
      {
        question: 'Was kennzeichnet den Zalando-Ansatz im Key Account Management?',
        options: [
          { id: 'A', text: 'Ein jährlicher PowerPoint-Review pro Account' },
          { id: 'B', text: 'Ein digitales Account-Profil mit KPIs, auf das KAM und Partner gemeinsam zugreifen' },
          { id: 'C', text: 'Executive Sponsoren aus dem oberen Management' },
          { id: 'D', text: 'Bereichsübergreifende Account-Teams aus Technik und Produktion' },
        ],
        correctAnswer: 'B',
        hint: 'Kundenentwicklung als kontinuierlicher Prozess mit geteilter, aktueller Datenbasis.',
      },
      {
        question: 'Wofür steht das DHL-Beispiel?',
        options: [
          { id: 'A', text: 'Für digitale Transparenz über ein gemeinsames Dashboard' },
          { id: 'B', text: 'Für Executive Sponsoren, die als Türöffner und Eskalationskontakt auf C-Level agieren' },
          { id: 'C', text: 'Für interdisziplinäre, internationale Account-Teams' },
          { id: 'D', text: 'Für ein streng standardisiertes Betreuungsmodell' },
        ],
        correctAnswer: 'B',
        hint: 'KAM plus Executive ergibt einen doppelten Wirkungshebel: operativ und strategisch.',
      },
    ],
  },
};
